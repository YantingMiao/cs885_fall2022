...
print('value iteration number:', nIterations)
...
print('Pollicy iteration number:', nIterations)
print('*' * 64)
...
print('ModifiedPollicy iteration number:', nIterations)

print('=' * 128)
n_eval = 10
for i in range(1, n_eval + 1):
    nIterations = mdp.modifiedPolicyIteration(np.zeros(mdp.nStates,dtype=int),np.zeros(mdp.nStates), nEvalIterations=i, tolerance=0.01)[2]
    print('nEvaluations = %d, nIterations = %d' % (i, nIterations))
    print('*' * 64)