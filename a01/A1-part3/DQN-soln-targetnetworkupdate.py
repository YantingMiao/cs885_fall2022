...
# Plot the curve for multiple seeds
def plot_seeds(name, color):
    # Train for different seeds
    curves = []
    for seed in SEEDS:
        curves += [train(seed)]
    # Plot the curve for the given seeds
    plot_arrays(curves, color, name)
...
if __name__ == "__main__":
    ...
    plot_seeds('dqn-tn-10', 'gray')
    TARGET_UPDATE_FREQ = 50
    plot_seeds('dqn-tn-50', 'darkgray')
    TARGET_UPDATE_FREQ = 100
    plot_seeds('dqn-tn-100', 'lightgray')
